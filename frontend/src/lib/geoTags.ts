...
export const GEO_CANONICAL = new Map<string, string>([
  ...
  ['korean', 'korea'], ['korea', 'korea'], ['south korea', 'korea'],
  ...
  // Full country-name forms Last.fm also serves as standalone tags — these
  // previously slipped through isGeoTag and got displayed as a "genre".
